...
#ifndef USE_CUDA_HASH
void MD5HashCUDA(const vector<string> &, vector<bit32> &)
{
	throw runtime_error("MD5HashCUDA requires building with make cuda");
}

void MD5HashCUDAPrefixValues(const string &, const vector<string> &, vector<bit32> &)
{
	throw runtime_error("MD5HashCUDAPrefixValues requires building with make cuda");
}
#endif
