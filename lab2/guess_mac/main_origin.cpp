...
// 编译指令如下
// g++ main_origin.cpp train.cpp guessing.cpp md5.cpp -o main
// g++ main_origin.cpp train.cpp guessing.cpp md5.cpp -o main -O1
// g++ main_origin.cpp train.cpp guessing.cpp md5.cpp -o main -O2
